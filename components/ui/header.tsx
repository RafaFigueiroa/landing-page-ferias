...
export default function Header() {
  return (
    <header className="bg-[url(/header/topo-maragogi.png)] bg-cover bg-bottom w-full h-[600px] overflow-hidden">
      <div className="flex flex-col items-center relative pt-4 space-y-36 mx-2">
        <Image src="/header/ferias-julho-maragogi.svg" alt="Férias de Julho 2024 - Salinas Maragogi" width={524.6} height={233.3} className="min-w-[525px]"/>
